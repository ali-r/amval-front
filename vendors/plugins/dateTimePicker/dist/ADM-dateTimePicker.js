    ...
    var ADMdtpProvider = function() {
        ...
        var options = {
            ...
            gregorianDic: {
                ...
                // todayBtn: 'Today',
                // Edited by m.eslahi@gandom.co
                todayBtn: 'Go Today',
                todaySelectionBtn: 'Select Today'
            },
            jalaliDic: {
                title: 'جلالی',
                ...
                // todayBtn: 'امروز',
                // Edited by m.eslahi@gandom.co
                todayBtn: 'برو به امروز',
                todaySelectionBtn: 'انتخاب امروز'
            }
        };
        ...
        return {
            ...
            link: function(scope, element, attrs) {
                ...
                scope.selectToday = function(){
                    ...
                    scope.selectThisDay(_standValue);
                }
    ...
    var ADMdtpDirective = function(ADMdtp, ADMdtpConvertor, ADMdtpFactory, constants, $compile, $timeout) {
        ...
        return {
            ...
            scope: {
                ...
                onOpen: '&?',
                onClose: '&?',
                inputplaceholder: '@' //added by m.eslahi@gandom.co
            },
